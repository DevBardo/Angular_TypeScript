...
export class Game {
    ...
    init(words: Array<Word>): void {
        ...
        this._word = words[randomIndex].name;
        ...
        uniquement proposer une lettre, au fur à et mesure le mot se dévoilera si vous devinez les lettres.
    ...
    */
    ...
    run(choice: string): void {
        ...
        if (choice.length === 1) {
            ...
            this._message = `Désolé, mais vous proposez un caractère vide ou plus d'un caractères, n'est pas dans le mot caché : ${this.show()}`;
        }
